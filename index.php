...
<body>
    <section class="row">
        <aside class="col-3 col-xl-2 bg-pr full-height-overflow" style="border: 1px solid black;">
            <ul>
                <a href="./">
        ...
        <main class="col-9 col-xl-10 bg-gray-100 border-min full-height-overflow" style="border: 1px solid black;">
            <div class="container">
